...
?>
<h2 class="register-title">ユーザー登録</h2>

<?php if ($error): ?>
<p class="register-error"><?= str2html($error) ?></p>
<?php endif; ?>
...
<form method="post" action="register.php" enctype="multipart/form-data" class="register-form">
  ...
  <p class="register-item">
    <label class="register-label">
      アイコン画像（任意）
      <input class="register-file" type="file" name="icon" accept="image/jpeg,image/png,image/webp">
    </label>
  </p>
